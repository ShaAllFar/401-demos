...
bmp.reserved_one = bitmap.readUInt16LE(6);//0
bmp.reserved_two = bitmap.readUInt16LE(8);//0
...
bmp.bpp = bitmap.readUInt16LE(28);//8 bits per pixel
...
bmp.image_data = bitmap.readUInt32LE();
console.dir(bmp);
